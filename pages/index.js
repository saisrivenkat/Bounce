      ...
      <Row>
        ...
        <Col span={6}>
          <div className={Styles.bounceTool}>
            ...
            <svg className="MuiSvgIcon-root jss65" focusable="false" viewBox="0 0 29 23" aria-hidden="true"><circle cx="4" cy="4" r="4" fill="currentColor"></circle><circle cx="25" cy="4" r="4" fill="currentColor"></circle><circle cx="15" cy="19" r="4" fill="currentColor"></circle></svg>
              <p>Coming Soon</p>
            </div>
            <div className={Styles.card}>
